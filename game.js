...
//     for(var c=0; c<brickColumnCount; c++) {
//         for(var r=0; r<outerRowCount; r++) {
//           if(outerBricks[c][r].status == 0) {
//             var newBrickX = (c*(brickWidth+brickPadding))+brickOffsetLeft;
//             var newBrickY = (r*(brickHeight+brickPadding) + (brickRowCount * (brickPadding + brickHeight)))+brickOffsetTop;
//             outerBricks[c][r].x = newBrickX;
//             outerBricks[c][r].y = newBrickY;
//             canvas.beginPath();
//             canvas.rect(newBrickX, newBrickY, brickWidth, brickHeight)
//             // console.log(brickX+ outerBrickY);
//             // canvas.fillStyle = "00dd67"
//             // canvas.fillStyle = 'hsl(' + 360 * Math.random() + ', 50%, 50%)';
//             canvas.fill();
